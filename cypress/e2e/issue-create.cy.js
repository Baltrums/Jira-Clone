...
describe("Issue create", () => {
  ...
  it("Should create an issue and validate it successfully - Bug creation test", () => {
    // System finds modal for creating issue and does next steps inside of it
  ...
  it.only("Should create an issue and validate it successfully - Random Title and description", () => {
    ...
    cy.get('[data-testid="modal:issue-create"]')
      ...
      .within(() => {
        ...
        cy.get(".ql-editor").should("have.text", randomDescr);
        ...
        cy.get('[data-testid="form-field:type"]').within(() => {
          cy.get('[data-testid="select:type"]').click();
          cy.get('[data-testid="icon:close"]').click();
          cy.get('[data-testid="icon:task"]').click();
        ...
        cy.get('[data-testid="form-field:reporterId"]').within(() => {
          cy.get('[data-testid="select:reporterId"]').click();
          cy.get('[data-testid="icon:close"]').click();
          cy.get('[data-testid="avatar:Lord Gaben"]').click();
          cy.get('[data-testid="avatar:Lord Gaben"]')
            .scrollIntoView()
            .should("be.visible");
        });
    ...
    cy.get('[data-testid="board-list:backlog"]')
      ...
      .within(() => {
        ...
        cy.get('[data-testid="list-issue"]')
          ...
          .siblings()
          .within(() => {
            //Assert that no avatar and type icon are visible

            cy.get('[data-testid="avatar:Lord Gaben"]').should("not.exist");
